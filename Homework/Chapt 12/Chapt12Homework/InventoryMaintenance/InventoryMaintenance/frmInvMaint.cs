    ...
    public partial class frmInvMaint : Form
    {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            if (i != -1)
            {
                ...
                string msg = "Are you sure you want to delete " +invItem.Description + "?";

                DialogResult button = MessageBox.Show(msg, "DELETE THIS?", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
